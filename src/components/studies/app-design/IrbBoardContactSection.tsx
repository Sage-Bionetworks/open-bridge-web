  ...
  return (
    <Subsection heading="IRB or Ethics Board Contact">
      ...
      <FormGroupWrapper>
          ...
          <RadioGroup
            ...
            onChange={e => {
              if (e.target.value === 'affiliation_same') {
                const studyLeadObject = getContactPersonObject('principal_investigator')
        ...
        <FormControl className={clsx(!phoneNumberErrorState.isIrbPhoneNumberValid && 'error')}>
          <TextInputWrapper
            ...
            onBlur={() => {
              const isInvalidPhoneNumber = Utility.isInvalidPhone(irbPhoneNumber) && irbPhoneNumber !== ''
        ...
        <FormControl className={clsx(!emailErrorState.isIrbEmailValid && 'error')}>
          <TextInputWrapper
            SimpleTextInputStyles={SimpleTextInputStyles}
            ...
            onBlur={() => {
              const validEmail = Utility.isValidEmail(irbInfo.email || '') || !irbInfo.email

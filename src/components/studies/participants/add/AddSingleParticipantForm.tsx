  ...
  return (
    <>
      <FormGroup className={classes.addForm}>
              ...
              <SimpleTextInput
                ...
                onBlur={() =>
                  setValidationErrors(prev => ({
                    ...prev,
                    phone: Utility.isInvalidPhone(participant.phoneNumber || ''),
                  }))
                }
              />
              {validationErrors.phone && (
                <FormHelperText id="phone-text">phone should be in the format: (xxx)xxx-xxxx</FormHelperText>
              )}
            </FormControl>
        ...
        <FormControl>
          <TimezoneDropdown
            isRequired={scheduleEvents.find(e => e.eventId.includes('custom')) !== undefined}
            currentValue={participant.clientTimeZone || '-'}
            onValueChange={(clientTimeZone: string) => onChange({...participant, clientTimeZone})}
          />
        </FormControl>

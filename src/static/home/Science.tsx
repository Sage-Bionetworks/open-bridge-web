...
const Science: FunctionComponent<{}> = () => {
  return (
    <ScienceContainer>
      <Typography variant="h2">Science</Typography>
      <Grid
        container
        rowSpacing={5}
        sx={{
        ...
        <Grid item xs={12} lg={6}>
          <Box>
            <Typography component="p">
              Mobile toolbox has a web Science for researchers and a mobile app
              Science for study participants. You don't have to have a software
